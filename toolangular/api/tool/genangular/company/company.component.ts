...
export class CompanyComponent implements OnInit {	
  ...
  displayedColumns: string[] = ['id', 'email', 'password', 'avatar', 'fullname', 'phone', 'companyname', 'companyphone', 'personalscale', 'address', 'city', 'website', 'career', 'about', 'logo', 'bussinesslicence', 'position', 'personalemail', 'point', 'startads', 'endads', 'banner', 'pointbanner', 'startadsbanner', 'endadsbanner'];	
   ...
   */	
  getCompany() {	
    this.api.excuteAllByWhat({ 'idCompany': this.api.idCompany }, '60')	
      .subscribe(data => {	
        // set data for table	
...
export class CompanyDialog implements OnInit {	
  ...
  onOkClick(): void {	
    ...
    // this.input.born = this.api.formatDate(this.input.born);	
      ...
      this.api.excuteAllByWhat(this.input, ''+ Number(61 + this.type) +'').subscribe(data => {	
   ...
   */	
  onDeleteClick() {	
    this.api.excuteAllByWhat(this.input, '63').subscribe(data => {	
      this.dialogRef.close(true);	
